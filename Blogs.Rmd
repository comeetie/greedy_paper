...
sol_ms=list()
for (i in 1:nbrun){
  sol_h[[i]]=greed(Blogs$X)
  sol_h50[[i]]=greed(Blogs$X, alg=new("hybrid",pop_size=40))
  sol_h100[[i]]=greed(Blogs$X,alg=new("hybrid",pop_size=80))
  sol_seed[[i]]=greed(Blogs$X,alg=new("seed"))
  sol_ms[[i]]=greed(Blogs$X,alg=new("multistarts"))
}
```
