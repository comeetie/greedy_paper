...
for (i in 1:nbrun){
  sol_h[[i]]=greed(Jazz)
  sol_h50[[i]]=greed(Jazz, alg=new("hybrid",pop_size=40))
  sol_h100[[i]]=greed(Jazz, alg=new("hybrid",pop_size=80))
  sol_seed[[i]]=greed(Jazz,alg=new("seed"))
  sol_ms[[i]]=greed(Jazz,alg=new("multistarts"))
}
```
